...
export const softBrown = '#655C56';
export const tan = '#BBADA3';

export const solidGreen = '#3E6335';
export const lightGreen = '#ACCDA4';

export const solidBlue = '#226BAF';
export const lightBlue = '#A9CEEE';
